    ...
    <div class="card-body py-2">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-2">
                ...
                <select class="form-select form-select-sm" id="fJenis"><option value="">Semua jenis</option></select>
            </div>
            <div class="col-md-2">
                <label class="form-label">Nama Barang</label>
                <input type="text" class="form-control form-control-sm" id="fBarang" placeholder="Ketik nama barang">
            </div>
            <div class="col-md-2">
...
<script>
    ...
    function loadOptions() {
        $.getJSON('api/data_filter_ringkasan_obat.php', {mode: 'penerimaan'}, function(data) {
            ['jenis'].forEach(function(name) {
    ...
    function exportExcel() {
        ...
        XLSX.writeFile(wb, 'Ringkasan_Penerimaan_Obat_' + tgl + '.xlsx', {
            cellStyles: true
        });
    }
    ...
    $('#fBarang').on('keypress', function(e) {
        if (e.which === 13) {
            e.preventDefault();
            loadData();
        }
